...
public class PenentuJumlahHariGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        keluarButton.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    ...
    private void hitungButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungButtonActionPerformed
        ...
        if(tahunTextField.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error: isian tahun harus diisi!",
                "Error: isian tahun harus diisi!", JOptionPane.WARNING_MESSAGE);
        }else{
